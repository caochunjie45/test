...
* Update  : by kevin, 2011-3-12 11:20, set debug level gate to 1;
**********************************************************************************************************************
*/
...
#define EPDK_DEBUG_LEVEL_GATE         2

#if 0
#define eDbug(...)

#else
#define eDbug(...) (eLIBs_printf("L%d(%s):", __LINE__, __FILE__),                 \
    						     eLIBs_printf(__VA_ARGS__)									        )
#endif

#ifdef EPDK_DEBUG_LEVEL
#undef EPDK_DEBUG_LEVEL
#endif
...
#define EPDK_DEBUG_LEVEL EPDK_DEBUG_LEVEL_LOG_ALL
...
#if defined(__INF)
    #define __inf(...)            (eLIBs_printf("INF:L%d(%s):", __LINE__, __FILE__),                 \
    						     eLIBs_printf(__VA_ARGS__)									        )
#else
    #define __inf(...)
#endif
    ...
    #define __putc(c)           esSIOS_putchar(c)
