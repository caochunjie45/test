...
#define KMSG_USR_SYSTEM_USB_CONNECT (KMSG_USR_CLS_SYSTEM | 0x19)
#define KMSG_USR_SYSTEM_USB_DISCONNECT (KMSG_USR_CLS_SYSTEM | 0x1a)
...
#define KMSG_VAL_DEV_CONNECT		(KMSG_VAL_DEV_BASE + 3)
#define KMSG_VAL_DEV_DISCONNECT		(KMSG_VAL_DEV_BASE + 4)
