...
typedef struct progbars_action
{
...
typedef struct progbars_attribute
{
	progbar_para_t                   progbars_paint;
	
	progbars_action_t                progbars_action;

	
}progbars_attribute_t;
...
extern __s32  PROGBAR_SetLineSize( H_WIN hwin, __u32 line_size );
