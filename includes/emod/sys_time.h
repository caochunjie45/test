...
typedef __csp_tmr_para_t __hw_tmr_type_t;
...
typedef __csp_tmr_mode_e        __hw_tmr_mode_e;
#define TMR_SHOT_MODE_ONLYONE   CSP_TMR_TMR_MODE_ONE_SHOOT  //Timer will not automatically restart when it expires
#define TMR_SHOT_MODE_PERIODIC  CSP_TMR_MODE_CONTINUOUS     //Timer will     automatically restart when it expires
