...
#define PART_LETTER_GAMEDISK            'W'         /*测试虚拟盘符 *///add by hot.lee
...
SYSCALL_FSYS(__s32,  esFSYS_ftruncate)(__hdle, __u32 length);
SYSCALL_FSYS(__s32,  esFSYS_setvolname)(const char * /*partname like:"e:" */, char * /*vol name*/);
