...
ebook_uipara_t *get_ebook_uipara(void)  //cai modify for 480x272_middle
{
	...
	ebook_uipara.loading_lyr.x = (480-100)/2;
	ebook_uipara.loading_lyr.y = (272-100)/2;
	...
	ebook_uipara.page_lyr.y  = 248;//216 //cai modify
	ebook_uipara.page_lyr.w  = 480;//400 //cai modify
	ebook_uipara.page_lyr.h  = 24;

	ebook_uipara.mset_lyr.x  = 40;//0 //modify	//菜单图层
	ebook_uipara.mset_lyr.y  = 213;//181 //cai modify
	ebook_uipara.mset_lyr.w  = 400;
	ebook_uipara.mset_lyr.h  = 59;

	ebook_uipara.sset_bgmusic_lyr.x  = 40;//40+40;//40 //cai modify
	ebook_uipara.sset_bgmusic_lyr.y  = 120+32;//120  //cai modify
	ebook_uipara.sset_bgmusic_lyr.w  = 118;
	ebook_uipara.sset_bgmusic_lyr.h  = 54;//24*2+3+3=54

	ebook_uipara.sset_play_lyr.x  = 130;//130+40;//130 //cai modify//20+76
	ebook_uipara.sset_play_lyr.y  = 70+32;//70 //cai modify//240-60-102=
	ebook_uipara.sset_play_lyr.w  = 118;
	ebook_uipara.sset_play_lyr.h  = 102;//24*4+3+3=102

	ebook_uipara.sset_txtcolor_lyr.x  = 220;//220+40;//220 //cai modify//96+76=172
	ebook_uipara.sset_txtcolor_lyr.y  = 98+32;//98 //cai modify//240-60-78
	ebook_uipara.sset_txtcolor_lyr.w  = 118;
	ebook_uipara.sset_txtcolor_lyr.h  = 78;//24*3+3+3=78

	ebook_uipara.sset_goto_lyr.x  = 310;//310+40;//310 //cai modify//172+76=248
	ebook_uipara.sset_goto_lyr.y  = 150+32;//150 //cai modify//240-60-30
