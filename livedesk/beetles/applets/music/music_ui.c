...
{    
    ...
    { 
        ...
        { 480, 240 },               //fb size
        { 0, 0, 480, 240 },         //src rect
        { 0, 0, 480, 240 },         //scn rect   //cai modify for 480x272_middle
        { 0 },                      //reserved
    },
    ...
    //scroll bar ui
    {
    		{219,	7,	7,	224},					//scroll bar background
    		{221,	22,	3,	194},					//scroll 
    		6,										//head
    		1,										//body
    		6,										//tail
    ...
    //head bar ui   
    {
    	{210+50,40,400-210,150-40},					//headbar background
    	#if BEETLES_RTC_EXIST
		{156+70,3,26,16},
		{176+70,3,26,16},
    	{200+50,5,26,16},								//播放模式状态图标
    	{226+50,5,50,16},								//EQ模式状态图标		
    	{226+50,5,26,16},								//背光关闭时间图标
    	{278+50,5,26,16},								//音量图标
    	{304+50,3,18,16},								//音量text
    	{326+50,6,31,12},								//电池图标
    	{359+50,3,40,16},								//时间显示区域
    	#else
		{164+70,3,30,16},								//SD/USB图标
		{164+70,22,30,16},								//SD/USB图标
		{219+70,22,150,16},								//当前曲目
    	{198+70,5,26,16},								//播放模式状态图标
    	{229+70,5,50,16},								//EQ模式状态图标		
    	{284+70,5,26,16},								//背光关闭时间图标
    	{315+70,5,26,16},								//音量图标
    	{341+70,4,18,16},								//音量text
    	{364+70,6,31,12},								//电池图标
    	{0,0,0,16},									//时间显示区域
		#endif
    },			
    //palyer ui
    {
    	{210+50,40,400-210,120-40},					//控制按钮背景区域()与频谱共用
    	{210+50,120,190,16},							//按键提示字符区域
    	{254+50,68,26,16},								//播放模式按钮  
    	{288+50,68,26,16},								//EQ模式按钮               
    	{324+50,68,26,16},								// 背光时间控制按钮             
    	
    	{228+50,100,26,16},							//上一首按钮                
    	{261+50,100,26,16},							//下一首按钮                
    	{294+50,100,26,16},							//播放暂停按钮              
    	{327+50,100,26,16},							//快退按钮                  
    	{360+50,100,26,16},							//快进按钮   
    	               
    	{214+50,154,26,20},							//播放状态图标(暂停或播放)	
    	
    	{239+3+50,160 - 21,70,20},	              		//当前播放时间              
    	{239+146-70-3+28+50 ,160 - 21,60,20},			//总时间显示区域
    	
    	{239+50,160,5,4},								//进度条head
    	{239+50,160,146,4},							//进度条body    	
    	{239+5+50,160,5,4},							//进度条point,从head之后，因此加5   	
    	{239+146-5+50,160,5,4},						//进度条tail
    	
    	{213+40,		183,26,16},						//演唱者图标
    	{213+26+40,	183,80,16},						//演唱者名称
    	{310+50,		183,26,16},						//文件大小图标
    	{310+26+55,	183,80,16},						//文件大小显示
    	
    	{213+40,		213,26,16},						//专辑名称图标
    	{213+26+40,	213,80,16},						//专辑名称
    	{310+50,		213,26,16},						//bitrate图标
    	{310+26+55,	213,80,16},						//bitrate大小显示
    },
    ...
    {				//ID															res	handle,    	res buffer    
        ...
        { ID_MUSIC_VOLUME_MUTE_BMP,    			NULL,  				 NULL }, 	//
        				//bettery
