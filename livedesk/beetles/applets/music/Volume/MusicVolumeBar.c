...
const VolumeBarUI_t MusicVolBarUI = {
		{40,272-21,400,21},					//Background rect
...
__s32 MusicVolumeMuteEvent(void *Attr)
{
	music_player_ctrl_t *This = Attr;
	if(This == NULL)
	{
...
{	
	...
	VBPara.Event.VolExitKey = GUI_MSG_KEY_ESCAPE;
	...
	VBPara.Event.OnMute = MusicVolumeMuteEvent;   //cai++ for 静音处理
