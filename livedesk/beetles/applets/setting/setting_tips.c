...
H_LYR setting_tips_layer_create(RECT *rect)
{
	...
	lstlyr.scn_win.x		= (480-SET_TIPS_W)/2; //cai modify
	lstlyr.scn_win.y		= (272-60-SET_TIPS_H)/2;//240为屏幕高度，60为底端高度//cai modify
...
static __s32 setting_tips_paint_all(__gui_msg_t *msg)
{
	...
	gui_rect.x0 = tips_ctrl->tips_uipara->tip_fsize_pos.x ;
	...
	eLIBs_strcat(tips_ctrl->svers, SW_VERSION);
	GUI_DispStringInRect(tips_ctrl->svers, &gui_rect , GUI_TA_LEFT|GUI_TA_VCENTER);
