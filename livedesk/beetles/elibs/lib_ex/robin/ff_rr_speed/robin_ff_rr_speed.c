...
__s32 robin_set_pitch_level(__s32 level)
{
    return esMODS_MIoctrl( robin_hced, CEDAR_CMD_SET_PITCH_LEVEL, level, NULL );    
}

__s32 robin_get_pitch_level(void)
{
    return esMODS_MIoctrl( robin_hced, CEDAR_CMD_GET_PITCH_LEVEL, 0, NULL );    
}
