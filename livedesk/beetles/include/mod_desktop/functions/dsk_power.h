...
__s32 dsk_power_get_battery_level(power_level_e *level,__s32 *is_full);		// 剩余电量level

__s32 dsk_power_get_voltage_level(power_level_e *level,__s32 *is_full);		// 工作电压level
...
__bool dsk_power_is_full(void);	/* 是否满电 */
