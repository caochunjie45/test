...
{		
	...
	void 						(*ptr_dsk_keytone_send)						(void);
	void 						(*ptr_dsk_keytone_reserved[3])				(void);
	
	//dsk_usbh.h
	__s32						(*ptr_dsk_send_insmod_usbh_cmd) 			(__u32 hostno);
	__s32						(*ptr_dsk_send_rmmod_usbh_cmd)				(__u32 hostno);
	__bool						(*ptr_dsk_usbh_is_working)					(__u32 hostno);
	...
	void						(*ptr_dsk_speaker_onoff)						(__u32 onoff);
	__bool						(*ptr_dsk_speaker_is_on)						(void);
	void						(*ptr_set_record_is_play)						(__bool val);	
	__bool						(*ptr_dsk_record_is_play)						(void);
	void						(*ptr_dsk_set_fsm_statu)						(__s32 sta);	
	__s32						(*ptr_dsk_get_fsm_statu)						(void);
	__s32						(*ptr_dsk_set_is_phone_in)						(__bool val);
	__bool						(*ptr_dsk_get_is_phone_in)						(void);
	__s32						(*ptr_dsk_set_is_mic_in)						(__bool val);
	__bool						(*ptr_dsk_get_is_mic_in)						(void);	
	...
	void*						(*ptr_dsk_theme_hdl2buf_ufo)					( HTHEME handle,void* sharebuf );
	//dsk_orchid.h

	//dsk_power.h    
	__s32                   	(*ptr_dsk_power_get_battery_level)  		(power_level_e *level,__s32 *is_full);     // 剩余电量level
	__s32                   	(*ptr_dsk_power_get_voltage_level)  		(power_level_e *level,__s32 *is_full);     // 工作电压level
	...
	__s32 						 (*ptr_dsk_audio_echo_close) (__s32 direct_off);
...
#define	dsk_keytone_send						(DESKTOP_FUNC_ENTRY->ptr_dsk_keytone_send)
...
#define	dsk_speaker_onoff					(DESKTOP_FUNC_ENTRY->ptr_dsk_speaker_onoff)		
#define	dsk_speaker_is_on					(DESKTOP_FUNC_ENTRY->ptr_dsk_speaker_is_on)		
#define	set_record_is_play					(DESKTOP_FUNC_ENTRY->ptr_set_record_is_play)		
#define	dsk_record_is_play					(DESKTOP_FUNC_ENTRY->ptr_dsk_record_is_play)		
#define	dsk_set_fsm_statu					(DESKTOP_FUNC_ENTRY->ptr_dsk_set_fsm_statu)		
#define	dsk_get_fsm_statu					(DESKTOP_FUNC_ENTRY->ptr_dsk_get_fsm_statu)		
#define	dsk_set_is_phone_in					(DESKTOP_FUNC_ENTRY->ptr_dsk_set_is_phone_in)		
#define	dsk_get_is_phone_in					(DESKTOP_FUNC_ENTRY->ptr_dsk_get_is_phone_in)		
#define	dsk_set_is_mic_in					(DESKTOP_FUNC_ENTRY->ptr_dsk_set_is_mic_in)		
#define	dsk_get_is_mic_in					(DESKTOP_FUNC_ENTRY->ptr_dsk_get_is_mic_in)	
...
#define	dsk_theme_hdl2buf_ufo					(DESKTOP_FUNC_ENTRY->ptr_dsk_theme_hdl2buf_ufo)					
