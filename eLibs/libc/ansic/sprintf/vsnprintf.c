...
extern int eLIBs_vfprintf(__FILE_vsnprintf * __restrict op, register const char * __restrict fmt, va_list ap);
int eLIBs_vsnprintf(char *__restrict buf, size_t size,
			  const char * __restrict format, va_list arg)
{
	...
	rv = eLIBs_vfprintf((__FILE_vsnprintf *) &f, format, arg);
	if (size) {
