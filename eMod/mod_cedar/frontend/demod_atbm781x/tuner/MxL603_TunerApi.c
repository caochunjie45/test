                                                  ...
                                                  MXL_BOOL singleSupply_3_3V)
{
  ...
  if (MXL_ENABLE == singleSupply_3_3V)
	...
	////reg test test
	//MxLWare603_OEM_ReadRegister(devId, 0x12, &readData);
	//__msg("1111------test 0x12 = 0x%x\n",readData);
		
       //MxLWare603_OEM_WriteRegister(devId, 0x12, 0x01);
	//MxLWare603_OEM_ReadRegister(devId, 0x12, &readData);
	//__msg("2222------test 0x12 = 0x%x\n",readData);
	///////////
	//MxLWare603_OEM_ReadRegister(devId, 0x00, &readData);
	//__msg("------test 0x00 = 0x%x\n",readData);

      //MxLWare603_OEM_WriteRegister(devId, 0x12, 0x01);
	//MxLWare603_OEM_ReadRegister(devId, 0x12, &readData);
	//__msg("3333------test 0x00 = 0x%x\n",readData);
	/////////
                                                          ...
                                                          MXL_BOOL* refLockPtr)
{
  ...
  if ((rfLockPtr) && (refLockPtr))
  {
    ...
    //MxL_DLL_DEBUG0(" RfSynthStatus = %d, RefSynthStatus = %d", (UINT8)rfLockStatus,(UINT8)refLockStatus); 
