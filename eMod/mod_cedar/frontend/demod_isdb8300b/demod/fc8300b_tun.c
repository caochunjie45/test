...
__s32 fc8300b_write(HANDLE handle, DEVICEID devid, __u8 addr, __u8 data)
{
	__s32 res;
...
__s32 fc8300b_read(HANDLE handle, DEVICEID devid, __u8 addr, __u8 *data)
{
	__s32 res;
...
/*__s32 fc8300b_bb_write(HANDLE handle, DEVICEID devid, __u16 addr, __u8 data)
{
	__s32 res;
...
__s32 fc8300b_bb_read(HANDLE handle, DEVICEID devid, __u16 addr, __u8 *data)
{
	__s32 res;
...
static __s32 fc8300b_tuner_set_pll(HANDLE handle, DEVICEID devid, __u32 freq,
							__u32 offset)
{
	...
	for (j = 0; j < 4; j++) {
		...
		fc8300b_write(handle, devid, 0x5a, (__u8) n_val);
		fc8300b_write(handle, devid, 0x50, 0xe3);
		fc8300b_write(handle, devid, 0x50, 0xff);
		fc8300b_write(handle, devid, 0x58, (__u8) ((k_val >> 8) & 0xff));
		fc8300b_write(handle, devid, 0x59, (__u8) ((k_val) & 0xff));
...
static void fc8300b_1seg_init(HANDLE handle, DEVICEID devid, __u16 filter_cal)
{
...
static void fc8300b_tmm_1seg_init(HANDLE handle, DEVICEID devid, __u16 filter_cal)
{
	fc8300b_write(handle, devid, 0x00, 0x00);
...
static void fc8300b_tsb_1seg_init(HANDLE handle, DEVICEID devid, __u16 filter_cal)
{
	fc8300b_write(handle, devid, 0x00, 0x00);
...
static void fc8300b_tsb_3seg_init(HANDLE handle, DEVICEID devid, __u8 filter_cal)
{
	fc8300b_write(handle, devid, 0x00, 0x00);
	fc8300b_write(handle, devid, 0x02, 0x05);
	fc8300b_write(handle, devid, 0x03, 0x04);
...
static void fc8300b_13seg_init(HANDLE handle, DEVICEID devid, __u8 filter_cal)
{
	fc8300b_write(handle, devid, 0x00, 0x00);
	fc8300b_write(handle, devid, 0x02, 0x01);
	fc8300b_write(handle, devid, 0x03, 0x04);
...
static void fc8300b_tmm_13seg_init(HANDLE handle, DEVICEID devid, __u8 filter_cal)
{
	fc8300b_write(handle, devid, 0x00, 0x00);
	fc8300b_write(handle, devid, 0x02, 0x03);
	fc8300b_write(handle, devid, 0x03, 0x04);
...
__s32 fc8300b_tuner_init(HANDLE handle, DEVICEID devid,
		enum BROADCAST_TYPE broadcast)
{
	...
	fc8300b_write(handle, devid, 0x4b, (__u8) (FC8300B_XTAL_FREQ / 1000));
...
static void fc8300b_set_freq_1seg(HANDLE handle, DEVICEID devid, __u32 freq)
{
	__u8 i = 0;
...
static void fc8300b_set_freq_tmm_1seg(HANDLE handle, DEVICEID devid, __u32 freq)
{
	__u8 i = 0;
...
static void fc8300b_set_freq_13seg(HANDLE handle, DEVICEID devid, __u32 freq)
{
	__u8 i;
...
static void fc8300b_set_freq_tmm_13seg(HANDLE handle, DEVICEID devid, __u32 freq)
{
	__u8 i;
...
static void fc8300b_set_freq_catv_13seg(HANDLE handle, DEVICEID devid, __u32 freq)
{
	__u8 i;
...
__s32 fc8300b_set_freq(HANDLE handle, DEVICEID devid, __u32 freq)
{
	__u8 i;
	__u8 offset = 0;
	__u8 tf_cal_set = 0;
...
__s32 fc8300b_get_rssi(HANDLE handle, DEVICEID devid, __s32 *rssi)
{
	__s8 tmp = 0;
	__u8 filter_r_value = 0;

	fc8300b_read(handle, devid, 0xeb, (__u8 *) &tmp);
	*rssi = tmp;
...
__s32 fc8300b_tuner_deinit(HANDLE handle, DEVICEID devid)
{
	return BBM_OK;
}
