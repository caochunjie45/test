...
__s32 (*fc8300_ac_callback)(unsigned long userdata, __u8 bufid, __u8 *data, __s32 length) = NULL;
__s32 (*fc8300_ts_callback)(unsigned long userdata, __u8 bufid, __u8 *data, __s32 length) = NULL;

unsigned long fc8300_ac_user_data;
unsigned long fc8300_ts_user_data;

#ifndef BBM_I2C_TSIF
static __u8 ts_buffer[TS0_BUF_LENGTH+4];

static void fc8300_data(HANDLE handle, DEVICEID devid, __u8 buf_int_status)
{
	__u32 size = 0;
...
#ifdef BBM_AUX_INT
static void fc8300_aux_int(HANDLE handle, DEVICEID devid, __u8 aux_int_status)
{
...
{
#ifdef BBM_AUX_INT
	__u8 aux_int_status = 0;
#endif

#ifndef BBM_I2C_TSIF
	__u8 buf_int_status = 0;
