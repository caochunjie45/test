...
#define DEMODULATOR_MODE                        (0) //* 0: DVB-T
                                                    //* 1: ISDB-T
                                                    //* 2: CMMB
                                                    //* 3: DTMB
                                                    //* 4: ATSC
...
#define TS_INTERFACE_ERROR_SIGNAL_POLARITY      (1) //* 0: high level active;       1: low level active.
#define TS_INTERFACE_DATA_VALID_SIGNAL_POLARITY (1) //* 0: high level active;       1: low level active.
#define TS_INTERFACE_PSYNC_SIGNAL_POLARITY      (1) //* 0: high level active;       1: low level active.
#define TS_INTERFACE_PACKET_SIZE                (0) //* 0: 188;             1: 192;             2: 204.

//* configuration for TV scanning library.
#define MAPLE_TV_STANDAR                        (MAPLE_TV_DVB_T) //* MAPLE_TV_DVB_T: DVB-T
