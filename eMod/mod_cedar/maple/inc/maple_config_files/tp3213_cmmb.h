...
#define DEMODULATOR_MODE                        (2) //* 0: DVB-T
                                                    //* 1: ISDB-T
                                                    //* 2: CMMB
                                                    //* 3: DTMB
                                                    //* 4: ATSC
...
#define CMMB_DEMOD_DRIVER 										(MAPLE_TV_CMMB_TELE) //*    MAPLE_TV_CMMB_SIANO :SIANO DRIVER
																																 //*	MAPLE_TV_CMMB_IF:  INNO DRIVER
																																	//* MAPLE_TV_CMMB_TELE: TELEPATH
...
//#define TS_INTERFACE_PACKET_SYNC_METHOD         (0) //* 0: by PSync signal;         1: by 0x47 sync byte.
...
#define MAPLE_TV_STANDAR                        (MAPLE_TV_CMMB) //* MAPLE_TV_DVB_T: DVB-T
