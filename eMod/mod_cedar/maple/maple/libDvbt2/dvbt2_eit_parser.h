...
#define	EVENT_NAME_LENGTH_LIMIT		64
...
{
	__u16					eventId;
	__u8					runningStatus;	//* bit 7 : 1- following 0-current ; bit (2~0) :defined as dvb2 si
	__u8					reserved;
...
typedef struct EIT_SERVICE_INFO_TYPE
{
	...
	eit_event_info_t*	pfEventHeader;
	...
	eit_event_info_t*	schdlEventHeader[EIT_SCHEDULE_TABLE_ID_NUM];
