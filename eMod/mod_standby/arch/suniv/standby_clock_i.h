...
*                                             All Rights Reserved
*
* File    : standby_clock_i.h
* By      : Sunny
* Version : v1.0
* Date    : 2012-2-22
* Descript: clock internal structure for standby.
* Update  : date                auther      ver     notes
*           2012-2-22 14:21:12	Sunny       1.0     Create this file.
*********************************************************************************************************
*/

#ifndef __STANDBY_CLOCK_I_H__
#define __STANDBY_CLOCK_I_H__
...
typedef struct __CCMU_AHBCLK_GATE0_REG0060
{
    ...
    __u32   SdramGate:1;        //bit14, gating AHB clock for SDRAM, 0-mask, 1-pass
     __u32   SdramDll:1;        //bit15, reserved
    __u32   reserved2:1;        //bit16, reserved
