...
#define APB1_GATING_REG 0xF1C2006C

//just use twi0 now
static __twic_reg_t *TWI_REG_BASE[3] = 
{
    (__twic_reg_t*)STANDBY_TWI0_REG_BASE,
    (__twic_reg_t*)STANDBY_TWI1_REG_BASE,
    (__twic_reg_t*)STANDBY_TWI2_REG_BASE
};
...
static int _standby_twi_stop(void)
{
    ...
    twi_reg->reg_ctl = (twi_reg->reg_ctl & 0xc0) | 0x10;
	
	//apb时钟低时必须假读一次stop bit,下一个周期才生效
